/**
 * Script simple pour corriger toutes les colonnes image
 * Fonctionne avec Railway CLI (variables d'environnement automatiques)
 */
...
async function fixAllImageColumns() {
  ...
  try {
    console.log("🔧 Correction de toutes les colonnes image...");
